                                    ...
                                    <div class="form-body">
                                        ...
                                        <form class="row g-3" method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="input-box">
                                                ...
                                                <div class="form-group">
                                                    <input class="form-control form--control" id="name" type="text" name="shopname" placeholder="Enter you shop name">
                                                    <span class="la la-user input-icon"></span>
                                                </div>
                                            </div><!-- end input-box -->
                                            <div class="col-12">
                                            ...
                                            @endif
                                            <button class="btn btn-primary" type="submit">Register Account <i class="ml-1 la la-arrow-right icon"></i></button>
                                <p class="pt-2 fs-14">Already have an account? <a href="{{route('loginpage')}}" class="text-color hover-underline">Log in</a></p>
                                        </form>
                                    </div>
