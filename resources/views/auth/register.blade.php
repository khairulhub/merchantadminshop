...
<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-input-label for="email" :value="__('Shop Email')" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="shopname" class="block w-full mt-1" type="text" name="shopname" :value="old('shopname')" required />
            <x-input-error :messages="$errors->get('shopname')" class="mt-2" />
        </div>

        <!-- Shop Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('Shop Password')" />
