        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="p-0 mb-0 breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add Store List</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="mx-auto col-xl-10">
            ...
            <div class="card">
                <div class="p-4 card-body">
                    ...
                    <form id="myForm" action="{{ route('store.storelist') }}" method="POST" class="row g-3" enctype="multipart/form-data">
